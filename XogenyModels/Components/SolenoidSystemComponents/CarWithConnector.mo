...
model CarWithConnector
  ...
  Modelica.Blocks.Interfaces.RealOutput v annotation(Placement(visible = true, transformation(origin = {22.308, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {22.308, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
initial equation
  c.s = x0;
  der(c.s) = v0;
equation
