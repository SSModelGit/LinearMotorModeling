...
model MultiBodyEE
  ...
  Components.SolenoidSystemComponents.Solenoid solenoid(N = 50, A = 0.005, m = 1.257e-06, V = 20, R = 2, PWM = 1, Px = 0.5, h = 0.05) annotation(Placement(visible = true, transformation(origin = {42.5, 15}, extent = {{22.5, -22.5}, {-22.5, 22.5}}, rotation = 0)));
equation
