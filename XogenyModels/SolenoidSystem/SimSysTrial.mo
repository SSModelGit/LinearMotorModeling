...
model SimSysTrial "Tries to use the graphical connectors"
  ...
  XogenyModels.Components.SolenoidSystemComponents.SolFWConnector sol1(N = 50, A = 1.5 ^ 2 * Modelica.Constants.pi, mu = 4 * Modelica.Constants.pi * 10 ^ (-7), V = 12.8, R = 2, PWM = 1, Px = 2, h = 2) annotation(Placement(visible = true, transformation(origin = {-87.5, 27.5}, extent = {{-22.5, -22.5}, {22.5, 22.5}}, rotation = 0)));
  XogenyModels.Components.SolenoidSystemComponents.SolFWConnector sol2(N = 50, A = 1.5 ^ 2 * Modelica.Constants.pi, mu = 4 * Modelica.Constants.pi * 10 ^ (-7), V = 12.8, R = 2, PWM = 1, Px = 4, h = 2) annotation(Placement(visible = true, transformation(origin = {-85.0, -7.7614}, extent = {{-22.2386, -22.2386}, {22.2386, 22.2386}}, rotation = 0)));
  XogenyModels.Components.SolenoidSystemComponents.SolFWConnector sol3(N = 50, A = 1.5 ^ 2 * Modelica.Constants.pi, mu = 4 * Modelica.Constants.pi * 10 ^ (-7), V = 12.8, R = 2, PWM = 1, Px = 6, h = 2) annotation(Placement(visible = true, transformation(origin = {-87.5, 65.0}, extent = {{-22.5, -22.5}, {22.5, 22.5}}, rotation = 0)));
  ...
  XogenyModels.Components.SolenoidSystemComponents.VControl control1(threshold = 0.1) annotation(Placement(visible = true, transformation(origin = {89.1647, 73.83839999999999}, extent = {{-19.1647, -19.1647}, {19.1647, 19.1647}}, rotation = 0)));
  ...
  XogenyModels.Components.SolenoidSystemComponents.VControl control2(threshold = 10000) annotation(Placement(visible = true, transformation(origin = {96.1694, -46.645}, extent = {{-23.8306, -23.8306}, {23.8306, 23.8306}}, rotation = 0)));
  ...
  XogenyModels.Components.SolenoidSystemComponents.VControl control3(threshold = 10000) annotation(Placement(visible = true, transformation(origin = {92.5, 15.0}, extent = {{-22.5, -22.5}, {22.5, 22.5}}, rotation = 0)));
  XogenyModels.Components.SolenoidSystemComponents.TrackWC channel(m = 0.75, l = 4, h = 1, mu = 1, g = 9.81, fTol = 0.001) annotation(Placement(visible = true, transformation(origin = {-84.2, -65.8}, extent = {{-20.8, -20.8}, {20.8, 20.8}}, rotation = 0)));
equation
  ...
  connect(c.v, channel.v) annotation(Line(visible = true, origin = {-68.128, -28.795}, points = {{34.353, 62.341}, {-1.872, -6.205}, {-10.248, -19.13}, {-22.312, -37.005}}, color = {0, 0, 127}));
  ...
  connect(channel.Cf, c.c) annotation(Line(visible = true, origin = {-49.819, -31.611}, points = {{-34.381, -34.189}, {4.819, -34.189}, {4.819, 1.611}, {12.371, 1.611}, {12.371, 65.157}}, color = {0, 127, 0}));
