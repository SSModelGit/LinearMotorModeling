...
model SimSysTrial "Tries to use the graphical connectors"
  ...
  XogenyModels.SolenoidSystem.XogenyModels.Components.SolenoidSystemComponents.SolFWConnector sol3(N=1, A=1, mu=1, V=12.8, R=2, PWM=1, Px=6.0, h=1) annotation(Placement(visible=true, transformation(origin={-87.5,65.0}, extent={{-22.5,-22.5},{22.5,22.5}}, rotation=0)));
