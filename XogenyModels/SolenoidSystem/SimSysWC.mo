...
model SimSysWC
  ...
  SolenoidSystemComponents.TimedController t2(onTime=2.0, offTime=3.0);
  SolenoidSystemComponents.TimedController t3(onTime=3.0, offTime=4.0);
  SolenoidSystemComponents.TrackWC channel(m=0.75, l=4, h=0.3, mu=0.2, g=9.81, stopt=4);
equation 
