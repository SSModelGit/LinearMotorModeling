...
model SimSysWC "Simple System Model expanded to multiple solenoids, using connectors"
  ...
  XogenyModels.Components.SolenoidSystemComponents.MagSen sensor1(Px = 2) annotation(Placement(visible = true, transformation(origin = {-97.96380000000001, 7.9874}, extent = {{-10.0, -10.0}, {10.0, 10.0}}, rotation = 0)));
