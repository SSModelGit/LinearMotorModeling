...
model SimpleSystem
  ...
  SolenoidSystemComponents.Car c(x0 = 0, v0 = 0, m = 0.75);
  SolenoidSystemComponents.JustForce f1(N = 1, A = 1, mu = 1, V = 12.8, R = 2, PWM = 1, Px = 2.0, h = 1);
...
equation
  ...
  t1.t = time;
  annotation(experiment(StartTime = 0, StopTime = 10, Tolerance = 1e-006, Interval = 0.02));
end SimpleSystem;