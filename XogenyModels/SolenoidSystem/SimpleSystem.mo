...
model SimpleSystem
  ...
  SolenoidSystemComponents.OldComponents.Car c(x0 = 0, v0 = 0, m = 0.75);
  SolenoidSystemComponents.OldComponents.JustForce f1(N = 1, A = 1, mu = 1, V = 12.8, R = 2, PWM = 1, Px = 2.0, h = 1);
  SolenoidSystemComponents.OldComponents.TimedController t1(onTime = 1.0, offTime = 6.0);
equation
