...
model TestMagSen
  ...
  Modelica.Blocks.Interfaces.RealOutput V annotation(Placement(visible=true, transformation(origin={5.0,-22.4646}, extent={{-20.0,-20.0},{20.0,20.0}}, rotation=0), iconTransformation(origin={3.0255,-21.3949}, extent={{-20.0,-20.0},{20.0,20.0}}, rotation=0)));
equation 
  magsen1.V=V;
  ...
  when time == 2.0 then
    assert(V<0.3, “Voltage sensor is high”);
  end when;
end TestMagSen;
